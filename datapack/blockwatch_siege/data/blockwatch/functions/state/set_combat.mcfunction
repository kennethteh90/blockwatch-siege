...
scoreboard players set @a[tag=bw.playing] bw.airstrike_cd 0
scoreboard players set @a[tag=bw.playing] bw.freeze_cd 0

title @a[tag=bw.playing] times 5 40 15
title @a[tag=bw.playing] title [{"text":"Wave ","color":"red","bold":true},{"score":{"name":"#wave","objective":"bw.wave"},"color":"yellow","bold":true}]
title @a[tag=bw.playing] subtitle {"text":"Defend the castle!","color":"white"}

tellraw @a[tag=bw.playing] [{"text":"[Siege] ","color":"gold"},{"text":"Wave ","color":"red"},{"score":{"name":"#wave","objective":"bw.wave"},"color":"yellow"},{"text":" has begun!","color":"red"}]
