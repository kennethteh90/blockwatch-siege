...
scoreboard players operation @a[tag=bw.placing,limit=1] bw.gold -= #cost.bomb bw.cfg
tellraw @a[tag=bw.placing,limit=1] [{"text":"[Siege] ","color":"gold"},{"text":"Bomb Tower placed! (-100g)  Range 10  DMG 15 AoE  Rate 3s","color":"red"}]
