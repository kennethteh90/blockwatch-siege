# blockwatch:waves/wave_09
# Wave 9: 3 Walkers + 5 Runners + 3 Brutes. Dual lane (alternating). Total 11.
...
execute if score #sp_idx bw.tmp matches 3  run scoreboard players set #sp_lane bw.tmp 1
execute if score #sp_idx bw.tmp matches 3  run function blockwatch:enemies/spawn/runner
execute if score #sp_idx bw.tmp matches 4  run scoreboard players set #sp_lane bw.tmp 2
...
execute if score #sp_idx bw.tmp matches 10 run scoreboard players set #sp_lane bw.tmp 1
execute if score #sp_idx bw.tmp matches 10 run function blockwatch:enemies/spawn/brute
