...
execute if score @s bw.enemy_type matches 1 run scoreboard players operation @a[tag=bw.playing] bw.gold += #reward.walker bw.cfg
...
execute if score @s bw.enemy_type matches 2 run scoreboard players operation @a[tag=bw.playing] bw.gold += #reward.runner bw.cfg
...
execute if score @s bw.enemy_type matches 3 run scoreboard players operation @a[tag=bw.playing] bw.gold += #reward.brute bw.cfg
...
execute if score @s bw.enemy_type matches 4 run scoreboard players operation @a[tag=bw.playing] bw.gold += #reward.boss bw.cfg
