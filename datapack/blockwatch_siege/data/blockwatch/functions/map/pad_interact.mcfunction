...
execute if score @s bw.place matches 1 if score #gold bw.gold >= #cost.arrow bw.cfg as @e[tag=bw.pad,tag=!bw.occupied,sort=nearest,limit=1,distance=..4] at @s run function blockwatch:towers/arrow/place
...
execute if score @s bw.place matches 2 if score #gold bw.gold >= #cost.frost bw.cfg as @e[tag=bw.pad,tag=!bw.occupied,sort=nearest,limit=1,distance=..4] at @s run function blockwatch:towers/frost/place
...
execute if score @s bw.place matches 3 if score #gold bw.gold >= #cost.bomb bw.cfg as @e[tag=bw.pad,tag=!bw.occupied,sort=nearest,limit=1,distance=..4] at @s run function blockwatch:towers/bomb/place
